...
app.delete("/backtest/<job_id>")(backtest_handler.cancel_job)
...
app.get("/backtest/<job_id>/submitted-ini")(backtest_handler.get_submitted_ini)
app.get("/backtest/<job_id>/project-manifest")(backtest_handler.get_project_manifest)
app.get("/backtest/<job_id>/project-bundle")(backtest_handler.get_project_bundle)
app.get("/backtest/<job_id>/execution-manifest")(backtest_handler.get_execution_manifest)
app.get("/backtest/<job_id>/materialization")(backtest_handler.get_materialization_audit)
app.get("/backtest/<job_id>/output-manifest")(backtest_handler.get_output_manifest)
app.get("/backtest/<job_id>/artifacts")(backtest_handler.get_output_artifacts)
app.get("/backtest/<job_id>/log-deltas-manifest")(backtest_handler.get_log_delta_manifest)
app.get("/backtest/<job_id>/log-deltas")(backtest_handler.get_log_delta_artifacts)
